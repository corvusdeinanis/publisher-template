...
(⚠️ Some things here might not apply to you, might be wrong, or straight up silly. I'd love to hear your opinions, though! And this is the Internet, so do use your due dilligence, and do your research. 

Leave a message in the chatbox [on my site](https://astroslair.xyz) or create an issue in the [Github Repository](https://github.com/corvusdeinanis/cuddly-train) I'm adding more ways to contact me, and also a discussion page on this site. Feel free to correct me, I love learning ^~^)
...
The aim of this little corner of the Internet is to make my personal wiki accessible, transparent (everything here is on the github repository, I'll be transparent about myy methods, etc), and free! [[Free as in freedom, not free beer.]]

### My Setup 
The site is built using [Quartz by Jack Zhao](https://github.com/jackyzha0/quartz). 🤍
I take notes using [Obsidian](https://obsidian.md), an amazing tool that truly is revolutionary.  
